...
export const SettingsExtraInf =()=>{

    return(
        <div className="card">
            <div className="card__border"></div>
            <div className="card_title__container">
              <span className="card_title">Visita mi GitHub</span>
              <p className="card_paragraph">
                🛠️ Descubre todos mis proyectos, las tecnologías que uso y mi forma de trabajar.
              </p>
            </div>
            <hr className="line" />

            <Link href={"https://github.com/Santicabral0478"}>
...
export default SettingsExtraInf;